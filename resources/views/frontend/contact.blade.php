...
<!-- Header Banner (Matching Reference UI) -->
<section aria-labelledby="contact-page-title" class="bg-[#0B3B60] text-white py-14 lg:py-20 border-b border-white/10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 id="contact-page-title" class="text-3xl sm:text-4xl lg:text-5xl font-black font-heading tracking-tight">
            Kontak Kami & Permintaan Penawaran
        </h1>
        <p class="mt-2 text-sm sm:text-base text-slate-300 max-w-2xl leading-relaxed">
            Kami siap mendengar dan membantu Anda. Hubungi kami melalui informasi di bawah ini atau kirimkan formulir permohonan penawaran harga (RFQ).
        </p>
    </div>
</section>
...
<section aria-label="Informasi Kontak dan Formulir" class="py-16 bg-slate-50/60">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Top Info Cards: Contact Information & Google Maps (Matching Reference UI) -->
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
            ...
            <div class="lg:col-span-5 bg-white rounded-3xl p-8 border border-slate-100 shadow-sm space-y-6 flex flex-col justify-between">
                <div>
                    <h2 class="text-xl font-black text-[#0B3B60] font-heading mb-6 border-b border-slate-100 pb-3">
                        Informasi Kontak
                    </h2>
            ...
            <!-- Google Maps Embed Box (7 Cols) -->
            <div class="lg:col-span-7 bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm min-h-[350px] relative">
                @if($contact->google_maps_embed)
                    {!! $contact->google_maps_embed !!}
                @else
                    <!-- Fallback Accessible Clean Interactive Map Frame -->
                    <iframe 
                        title="Lokasi Kantor BersihPrima" 
        ...
        <!-- RFQ Form Card (Matching Reference UI Bottom Grid) -->
            ...
            <div class="lg:col-span-7 p-8 sm:p-12 space-y-6">
                <div>
                    <h2 class="text-2xl font-black text-[#0B3B60] font-heading">
                        Kirim Pesan & Minta Penawaran (RFQ)
                    </h2>
                    <p class="text-xs text-slate-500 mt-1">
                        Punya pertanyaan atau ingin konsultasi kebutuhan cleaning properti Anda? Silakan isi form di bawah ini, tim kami akan segera merespons Anda.
                    </p>
                </div>
        ...
        <!-- 3 Bottom Trust Badges (Matching Reference UI) -->
