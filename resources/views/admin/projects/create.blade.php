...
@section('title', 'Tambah Galeri Proyek Baru')
@section('header-title', 'Create Project Gallery')
@section('header-subtitle', 'Unggah dokumentasi hasil kerja Sebelum & Sesudah pengerjaan')
...
<div class="max-w-3xl space-y-6">
    ...
    <div class="bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-[0_5px_25px_rgba(8,21,66,0.03)]">
        ...
        <div class="flex items-center justify-between pb-5 border-b border-slate-100 mb-6">
            <div>
                <h2 class="text-base font-bold text-slate-900 font-heading">Formulir Tambah Proyek Before & After</h2>
                <p class="text-xs text-slate-400">Lengkapi detail proyek dan unggah kedua foto komparasi</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data" class="space-y-6" novalidate>
            @csrf
            ...
            <div>
                ...
                <input 
                    ...
                    required 
                    value="{{ old('title') }}"
                    placeholder="Contoh: Pembersihan Karpet Gedung Perkantoran Sudirman"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input 
                        ...
                        type="text" 
                        value="{{ old('category') }}"
                        placeholder="Contoh: Cuci Sofa / Poles Marmer"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 p-5 rounded-3xl bg-slate-50/80 border border-slate-200/70">
                <div>
                    ...
                    >
                    @error('before_image') <p class="mt-1 text-xs text-rose-600">{{ $message }}</p> @enderror
                </div>
                ...
                <div>
                    ...
                    >
                    @error('after_image') <p class="mt-1 text-xs text-rose-600">{{ $message }}</p> @enderror
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea 
                        ...
                        name="description" 
                        rows="3" 
                        placeholder="Jelaskan tantangan, teknik pengerjaan, atau durasi penyelesaian..."
                        class="mt-1.5 block w-full rounded-2xl border border-slate-200 focus:border-[#24695c] focus:ring-[#24695c] px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 bg-slate-50/50 focus:bg-white focus:outline-none focus:ring-2 transition-all"
                ...
                <div class="max-w-xs">
                    ...
                    <input 
                        ...
                        name="completed_at" 
                        type="date" 
                        value="{{ old('completed_at', date('Y-m-d')) }}"
