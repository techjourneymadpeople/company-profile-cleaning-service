...
<div class="space-y-6">
    ...
    <div class="bg-white p-5 sm:p-6 rounded-3xl border border-slate-100 shadow-[0_5px_25px_rgba(8,21,66,0.03)] flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        <div>
            <h2 class="text-base font-bold text-slate-900 font-heading">Daftar Logo Klien & Mitra</h2>
            <p class="text-xs text-slate-400">Total {{ $clients->count() }} mitra terdaftar</p>
        </div>
    ...
    <!-- Clients Table Card with DataTable -->
