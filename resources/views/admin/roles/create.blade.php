...
@section('header-title', 'Create New Role')
@section('header-subtitle', 'Buat peran baru dan konfigurasikan penugasan hak akses (Assign To Permission)')
...
<div class="space-y-6">
    ...
    <div class="bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-[0_5px_25px_rgba(8,21,66,0.03)]">
        ...
        <div class="flex items-center justify-between pb-5 border-b border-slate-100 mb-6">
            <div>
                <h2 class="text-base font-bold text-slate-900 font-heading">Formulir Tambah Role & Hak Akses</h2>
                <p class="text-xs text-slate-400">Tentukan nama role dan centang permissions yang diberikan</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.roles.store') }}" class="space-y-6" novalidate>
            @csrf
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400">Pilih permission yang diizinkan untuk role ini</p>
                        </div>
                    </div>
