    ...
    <div>
        ...
        <div class="mt-1.5 relative rounded-2xl shadow-sm">
            ...
            <input 
                ...
                class="block w-full rounded-2xl border border-slate-200 focus:border-[#24695c] focus:ring-[#24695c] pl-11 pr-11 py-3 text-sm text-slate-900 placeholder:text-slate-400 bg-slate-50/50 focus:bg-white focus:outline-none focus:ring-2 transition-all"
            >
            <button 
                type="button" 
